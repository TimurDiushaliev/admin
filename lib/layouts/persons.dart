...
import 'package:admin/layouts/came.dart';
import 'package:admin/layouts/didntCome.dart';
import 'package:admin/layouts/info.dart';
...
class MyHomePageState extends State<MyHomePage> {
  ...
  void navToCamePage(context){
    Navigator.push(context, MaterialPageRoute(builder: (context)=> CamePage()));
  }

  void navToDidntComePage(){
    Navigator.push(context, MaterialPageRoute(builder: (context)=> LazyPersones()));
  }
                                      ...
                                      onSelected: (e) {
                                        api
                                            .delete(snapshot.data[index].id,
                                                context)
                                            .then((value) => setState(() {
                                                  api.fetchDataFromJson(context).then(
                                                      (value) => items = value);
                                                }));
                                      },
